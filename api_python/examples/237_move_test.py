...
def main():
    ...
    with utilities.DeviceConnection.createTcpConnection(args) as router:
        ...
        # Create required sinput()ervices
        ...
        feedback = base_cyclic.RefreshFeedback()
        print('World Position(m) x {:.2f} y {:.2f} z {:.2f}'.format(feedback.base.tool_pose_x, feedback.base.tool_pose_y, feedback.base.tool_pose_z))
        print('World Eular Rotation(deg) x {:.2f} y {:.2f} z {:.2f}'.format(feedback.base.tool_pose_theta_x, feedback.base.tool_pose_theta_y, feedback.base.tool_pose_theta_z), end='\n\n')
        
        px, py, pz, eux, euy, euz = 0.44, 0.19, 0.45, 90, -1.2, 150
        trans = 0.1
        rota = 10
